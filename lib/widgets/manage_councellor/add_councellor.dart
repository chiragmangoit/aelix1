...
class _CounsellorFormState extends State<CounsellorForm> {
  ...
  updateCounsellor(id, data) async {
    ...
    if (!mounted) return;
    if (result == 200) {
      Provider.of<Counsellor>(context, listen: false).fetchCounsellors();
      Flushbar(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    const Icon(Icons.school,size: 36,color: Color.fromRGBO(66, 77, 92, 1),),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        elevation: 3.0,
                          foregroundColor: const Color.fromRGBO(49, 39, 37, 1),
                          backgroundColor:
